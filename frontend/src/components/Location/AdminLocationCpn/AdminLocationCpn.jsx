...
import './AdminLocationCpn.css';
import { List, Avatar, Typography, Card, Button, Modal, Form, Input, Upload, message } from 'antd';
...
const AdminLocationCpn = () => {
    ...
    const handleUpdate = async () => {
        try {
            ...
            dispatch(updateLocation({ locationId: currentLocation._id, data: updatedData }));
                            ...
                            <List.Item.Meta
                                avatar={
                                    item.avatar?.url ? (
                                        ...
                                        <Avatar style={{ backgroundColor: '#87d068' }}>{item.provinceCity[0]}</Avatar>
                                    )
                                }
...
export default AdminLocationCpn;
