            ...
            <div className="main_navbar">
                ...
                <div className="content_nav">
                    <Row className="list_nav">
                        ...
                        >
                            <HomeOutlined
                                className={`icon_nav ${activeTab === 'hotel' ? 'active_icon-nav' : ''}`}
                            />
                            <p className="txt_nav">Hotel</p>
                        </Col>
                        <Col
                            span={4}
                            className="item_nav"
                        ...
                        >
                            <HomeOutlined
                                className={`icon_nav ${activeTab === 'tour' ? 'active_icon-nav' : ''}`}
                            />
                            <p className="txt_nav">Tour</p>
                        </Col>
                        <Col
                            span={4}
                            className="item_nav"
                        ...
                        >
                            <HomeOutlined
                                className={`icon_nav ${activeTab === 'restaurant' ? 'active_icon-nav' : ''}`}
                            />
                            <p className="txt_nav">Restaurant</p>
                        </Col>
                    </Row>
                </div>
