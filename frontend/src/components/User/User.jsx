...
import { getAllUser, updateRole, adminDeleteUser } from '../../service/adminService';
                ...
                <tbody>
                    {listUser?.map((user_item) => (
                        <tr key={user_item._id}>
                            <td>
                                <img src={user_item?.avatar?.url} alt="" className='list_avatar-user' />
                            </td>
                            ...
                            <td>
                                <button onClick={() => handleViewDetail(user_item._id)} className="edit-btn"><FaEye /></button>
                                <button onClick={() => handleEditRole(user_item._id, user_item.role)} className="edit-btn"><FaEdit /></button>
                                <button onClick={() => handleDeleteUser(user_item._id)} className="delete-btn"><MdDelete /></button>
                            </td>
                        </tr>
                    ))}
                </tbody>
